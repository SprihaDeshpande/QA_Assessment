...
#### [View file for Screen Recording](https://github.com/SprihaDeshpande/QA_Assessment/blob/master/bug_production.mov)
...
Here we answer the questions based on tools used throughout the project and look into concepts of making a test consistent.
